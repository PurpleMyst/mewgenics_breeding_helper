...
def _score_state_with_heuristic(
    ...
    """Evaluate total quality for a room assignment state using heuristic approximation."""
    ...
    for room in room_configs:
        ...
        room_kittens = heuristic_calc.get_expected_kittens(cats_in_room, room.comfort)
